...
- Hesabınızı ve tüm verilerinizi silebilirsiniz. İki yoldan biriyle:
  ...
  - **Uygulamayı açmadan:** fingosupport@gmail.com adresine e-posta hesabınızla
    birlikte "Hesabımı silmek istiyorum" yazarak talep edebilirsiniz; talebiniz
    30 gün içinde işleme alınır ve hesabınız, ilanlarınız, fotoğraflarınız ve
    mesajlarınız kalıcı olarak silinir.
